...
dayMode.addEventListener("click", (e) => {
  ...
  document.body.style.cssText = `background-image: linear-gradient(to right, #e2e3ec, #e2e3ec1e),url(./photos/bgLogo.png), color: #20203C, transition: .5s ease-in-out`;
  ...
  document.querySelector(".projectDescription").style.color = "#505050";
